...
public class Main extends Application {
    ...
    private Button cButton,powerButton,squareButton,plusButton,divideButton,dotButton,zeroButton,oneButton,
            miniButton,twoButton,threeButton,fourButton,fiveButton,sixButton,sevenButton,eightButton,nineButton ,
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        Scene scene = new Scene (mainRoot , 250 , 300);
        primaryStage.setScene(scene);
        primaryStage.setTitle("181380022-Calculator");
        primaryStage.show();
    }
